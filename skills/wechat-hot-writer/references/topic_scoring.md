...
- 身份证、复印件、刷脸、验证码、陌生链接、官方渠道这类个人信息安全提醒
- 朋友圈谣言、假通知、新规传闻、AI造假这类需要官方核对和家庭群转发提醒的内容
- 福利、优惠、出行、铁路积分、景区门票、社区办事这类“替家里人先核对”的服务信息
- 预约、实名、入口、时间点、养老金/社保/高龄津贴资格核验这类“别白跑、别误填、别乱点”的服务提醒
...
- 极端天气/节气提醒，例如高温、防暑、暴雨、换季穿衣，但只写日常边界，不写诊断治疗
- 朋友圈辟谣或假通知，例如“新规”“福利”“免费”“停发”类传闻，前提是能找到官方澄清或可靠来源
- 银发服务或出行提醒，例如适老化服务、优惠资格、养老金或高龄津贴认证、预约入口、时间节点
- 个人信息和支付安全提醒，例如复印件、实名核验、刷脸、验证码、征信排查
...
- 纯情绪跟风
- 只会制造焦虑，不给边界和动作
- 复述谣言标题却没有明确来源核验、官方说法、适用范围和“不该转发什么”
- 用热点当借口硬拐到 AI / 科技评论
- 年轻互联网黑话、娱乐圈塌房语境、只适合刷梗不适合家庭转述的话题
- 泛人物故事、抽象家庭情绪、社会观察空话；除非最后能收束到可执行的提醒或核对动作
